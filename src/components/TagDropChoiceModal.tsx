...
interface TagDropChoiceModalProps {
  ...
  blurEntryValue: boolean;
  blurPartition: boolean;
  blurPartnerTitle: boolean;
      ...
      >
        ...
        <div className="space-y-3 px-4 py-3">
          <p className="text-sm text-muted">
            {sublistLabel} &ldquo;
            <DemoBlurText blur={blurPartition}>{partitionLabel}</DemoBlurText>
            &rdquo; already has a track with entry &ldquo;
            <DemoBlurText blur={blurEntryValue}>{entryTagValue ?? ""}</DemoBlurText>
            &rdquo;. How should this move be applied?
          </p>
          ...
          >
            <RadioOption
              ...
              label={
                <>
                  Swap tracks with &ldquo;
                  <DemoBlurText blur={blurPartnerTitle}>
                    {swapPartner.track_title}
                  </DemoBlurText>
                  &rdquo;
                </>
              }
